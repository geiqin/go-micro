// Package kubernetes taken from https://github.com/geiqin/go-micro/blob/master/debug/log/kubernetes/kubernetes.go
...
import (
	...
	"github.com/geiqin/go-micro/util/kubernetes/client"
